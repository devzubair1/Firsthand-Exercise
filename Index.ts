...
let friendNames: string[]=["Arslan","Shahbaz", "Umair","Naveed"]
...
let favoriteCars:string[] = ["Toyta 1996 Model", "Honda 2006 Model", "Toyta Prius"];
...
let daughterName: string = "Ayesha Noor";
let guestName:string[]=["Umair", "Naveed", "Talha", "Abdullah"]
...
let guestList:string[]=["Umair","Talha", "Naveed","Abdullah"]

let personNotCome:string="Naveed";
...
let newGuest:string[]=["Arshad","Anwar","Zubair"]
 guestList.unshift(newGuest[0]);
 console.log(guestList)
 let insertIndex: number = Math.floor(guestList.length / 2);
...
let worldPlaces:string[]=["KSA","Dubai", "Turky", "USA", "Japan"]
...
let pakPlaces:string[]= ["Pakistan","Gilgit Baltistan", "Naga Parbat","Indus River", "Balti" ]
...
let name1:string= "Muhammad Arshad"
let name2:string= "Zubair Arshad"
...
let asianCountry:string[]=["Pakistan", "India", "Bangladesh", "China", "Afghanistan"]
let findCountry:String= "USA"
...
let Player1: string = "Zubair Arshad";
...
//Q.28
let favorite_fruits1:string[]=["Mango", "Banana", "Orange"];
...
//Q.29
let userName1:string[]=["Admin", "Naveed", "Arslan"]
...
//Q.31
let current_users2: string[] = ["Arshad", "Arslan", "RIZWAN", "iMRAN", "Kamran"];
let new_users2: string[] = ["Arslan", "Haris", "Babar", "Ali", "Arshad"];
...
//Q.29
let userName:string[]=["Admin", "Naveed", "Arslan"]
...
//Q.31
let current_users: string[] = ["Arshad", "Arslan", "RIZWAN", "iMRAN", "Kamran"];
let new_users: string[] = ["Arslan", "Haris", "Babar", "Ali", "Arshad"];
...
//Q32 
let favoritePizzas:string[]=["Pepperoni Pizza", "Bonefire Pizza", "chicken fajita pizza"]
...
//Q.34
let pets:string[]=["Hourse", "Dog", "Cat"]
...
//Q.36 
function make_shirtL(size: string = "Large", message: string = "I love TypeScript"): void {
    console.log(`Size: ${size}`);
    console.log(`Message: ${message}`);
}
make_shirtL();
